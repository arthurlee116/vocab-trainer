...
import type { DifficultyLevel, SuperJson, AnswerRecord, AnalysisSummary, SessionSnapshot } from '../types';
...
export const createSuperJson = (params: {
  words: string[];
  difficulty: DifficultyLevel;
  questionCountPerType?: number;
}) =>
  api
    .post<{ superJson: SuperJson }>('/generation/super-json', params)
    .then((res) => res.data.superJson);
